...
def create_bovw_traindf(feats_data_dict, kmeans_mag, kmeans_ang,mag_min, mag_max, ang_min, ang_max, idfpath):    
    ...
    #return bow_mag
#pickle.dump(idf_ang, open(os.path.join(idfpath,"idf_ang.pkl"), "wb")) on line 98
...
#def create_bovw_testdf(feats_data_dict, kmeans_mag, \
#                       mag_min, mag_max, idfpath):
    clusters_mag = kmeans_mag.cluster_centers_
    clusters_ang = kmeans_ang.cluster_centers_
    vids_list = feats_data_dict.keys()
    n_videos = len(vids_list)
